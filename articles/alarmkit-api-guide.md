...
| 項目 | UserNotifications | AlarmKit |
|------|------------------|----------|
| 通知音の長さ | 最大30秒 | 制限なし（停止するまで鳴り続ける） |
| サイレントモード | 音が鳴らない | 音が鳴る |
| おやすみモード | 通知されない | アラームとして鳴る |
| スヌーズ機能 | なし | あり |
| フルスクリーン表示 | なし | あり |
| ユーザーによる通知OFF | 簡単にOFFにできる | アラーム権限として管理 |
| 確実性 | 見逃される可能性大 | 標準アラームと同等 |
...
AlarmKitの活用例として、TVerのような動画配信アプリを考えてみます。
